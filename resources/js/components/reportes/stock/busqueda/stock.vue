					...
					<!-- ------------------------------------------------------------------------------------- -->
			  		...
			  		<div class="col-md-4 mb-3">
					    ...
					    <!-- ULTIMA VENTA -->
					  	...
					  	<label class="mt-3" for="validationTooltip01">Seleccione Fecha de Última Venta</label>
						...
						<label class="mt-3" for="validationTooltip01">Seleccione Fecha de Última Compra</label>
						<div id="sandbox-container">
							<div class="input-daterange input-group">
								   <input type="text" class="input-sm form-control form-control-sm" id="selectedInicialFechaCompra" v-model="selectedInicialFechaCompra"/>
								   <div class="input-group-prepend form-control-sm">
								   		<span class="input-group-text">a</span>
								   </div>
								   <input type="text" class="input-sm form-control form-control-sm" name="end" id="selectedFinalFechaCompra" v-model="selectedFinalFechaCompra"/>
							</div>
						</div>						  
        ...
        methods: {
	        ...
	        generarConsulta(){
	        	...
	        	this.datos = {
		        	...
		        	InicioCompra: String(this.selectedInicialFechaCompra),
		        	FinalCompra: String(this.selectedFinalFechaCompra),
		        	Marcas: this.selectedMarca,
		        	Categorias: this.selectedCategoria,
		        	AllBrand: this.onMarca,
		        	AllCategory: this.onCategoria,
		        	Stock: this.switch_stock
	        	};
