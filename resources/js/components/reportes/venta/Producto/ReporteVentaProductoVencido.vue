<template>
		<!-- REPORTE DE VENTAS POR PRODUCTOS VENCIDOS -->
	<div>
		<div class="card mt-3 shadow border-bottom-primary mb-3">
		  <div class="card-header">Reporte Venta de Productos Vencidos</div>
		    <div class="card-body">
			  	<div class="row">
					...
					<div class="col-4 ml-3">	
						<label>Seleccione Intervalo de Vencimiento</label>
	...
	<!-- FIN REPORTE DE VENTAS POR PRODUCTOS VENCIDOS -->
</template>
        ...
        methods: {
	        ...
	        descargar(){
	        	...
	        	if(this.generarConsulta() === true){
	        		me.descarga = true;
		        	axios({
					  url: '/export_venta_producto_vencido',
					  method: 'POST',
					  data: me.datos,
					  responseType: 'blob', // important
					   ...
					   link.href = url;
					   link.setAttribute('download', 'venta_vencidos_de_'+me.selectedInicialFecha+'_al_'+me.selectedFinalFecha+'.xlsx'); //or any other extension
		        ...
		        if(me.generarConsulta() === true) {
		        	...
		        	var tableVencimientoProducto = $('#tablaVencimientoProducto').DataTable({
		                ...
		                "ajax":{
		                  ...
		                  "url": "/ventaProductoVencidoDatatable",
		                  "dataType": "json",
		                  "type": "POST"
