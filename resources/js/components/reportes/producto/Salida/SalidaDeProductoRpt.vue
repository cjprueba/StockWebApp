		  ...
		  <div class="card-header">Reporte Salida de Productos</div>
		    <div class="card-body">
				...
				<div class="row mt-3">
		            <div class="col-md-4">
		                <label>Tipo</label>
		                <select v-model="tipo" class="custom-select custom-select-sm" v-bind:class="{ 'is-invalid': validarTipo }">
					...
					<div class="col-md-auto mt-4 ml-3">
						<div class="col-auto">
					...
					<table id="tablaSalidaProducto" class="table mb-3" style="width:100%">
				    	<thead>
					      <tr> 
					        <th>Código</th>
					        <th>Observacion</th>
		        ...
		        if(me.generarConsulta() === true) {
		        	...
		        	var tableSalidaProducto = $('#tablaSalidaProducto').DataTable({
				        ...
				        "buttons": [
				            ...
				            { extend: 'print', text: '<i class="fa fa-print"></i>', titleAttr: 'Imprimir', className: 'btn btn-secondary', title: 'rptSalida', messageTop: 'Salida de Productos', footer: true }
				        ],
		                "ajax":{
	                 			"data": {
	                 				datos: me.datos,
