<template>
	<div v-if="$can('ordenes.pendientes') && $can('ordenes')" class="container-fluid mt-4">
		<div class="row" >
			...
			<div class="col-md-12">
				<table id="tablaOrdenPendiente" class="table table-striped table-hover table-bordered table-sm mb-3" style="width:100%">
		            <thead>
		                <tr>
		                    <th>Código</th>
		                    <th>Cliente</th>
      ...
      methods: {
 	  ...
 	  mounted() {
            ...
            // PREPARAR DATATABLE 
	 		...
	 		var tableOrdenPendiente = $('#tablaOrdenPendiente').DataTable({
                "processing": true,
                "serverSide": true,
                "destroy": true,
                "bAutoWidth": true,
            ...
            // ------------------------------------------------------------------------
           	...
           	$('#tablaOrdenPendiente').on('click', 'tbody tr #mostrarDetalle', function() {
		        ...
		        me.mostrarModalOrdenPendiente(tableOrdenPendiente.row( row ).data().ORDEN_ID);
            ...
            $('#tablaOrdenPendiente').on('click', 'tbody tr #imprimirDireccion', function() {
	            ...
	            me.ordenID = tableOrdenPendiente.row( row ).data().ORDEN_ID;
            ...
            $('#tablaOrdenPendiente').on('click', 'tbody tr #imprimirFactura', function() {
	            ...
	            me.facturaPDF(tableOrdenPendiente.row( row ).data().ORDEN_ID);
