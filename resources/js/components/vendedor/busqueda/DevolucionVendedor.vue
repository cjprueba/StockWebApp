<template>
	...
	<div>
		<div class="card shadow border-bottom-primary" >
		  	<div class="card-header">Devolucion por vendedores y marcas</div>
			...
			<div class="card-body">
			  	<div class="form-row">
					...
					<div class="col-md-4">
						<label for="validationTooltip01">Seleccione vendedores</label> 
						<select multiple class="form-control" size="5" v-model="selectedCategoria" :disabled="onCategoria" v-bind:class="{ 'is-invalid': validarCategoria }">
						  <option v-for="categoria in categorias" :value="categoria.CODIGO">{{ categoria.NOMBRE }}</option>
						</select>
						<div class="invalid-feedback">
						...
						<div class="custom-control custom-switch mt-3">
						  ...
						  <label class="custom-control-label" for="customSwitch2">Seleccionar todos los vendedores</label>
						</div>
                      </div>
	...
	export default {
        ...
        methods: {
	        ...
	        llamarDatos(){
	        	...
	        	if(this.generarConsulta() === true) {
	        		me.cargado = true;
					axios.post('/devendedores', this.datos).then(function (response) {
						me.cargado = false;
