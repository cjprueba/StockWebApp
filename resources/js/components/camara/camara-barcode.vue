	            ...
	            <div class="modal-content">
	                ...
	                <div class="modal-body">
	                    ...
	                    <div class="text-center">
                         <select class="custom-select custom-select-sm" name="input-stream_constraints" id="deviceSelection">
                          </select>
        ...
        mostrarCamara(){
          ...
          $(function() {
              ...
              Quagga.onDetected(function(result) {
                  ...
                  if (code === me.ultimoCodigo) {
                      me.contador ++;
                  } else {
                      me.ultimoCodigo = code;
                      me.contador = 0; 
                  }
                  ...
                  if (me.contador === 5) {
                      ...
                      // LLAMAR FUNCION PARA SABER SI EXISTE PRODUCTO

                      Common.existeProductoCommon(code).then(data => {

                        if (data.response === true) {

                            // ------------------------------------------------------------------------

                            // CODIGO PARA ADJUNTAR FOTO DEL CODIGO 
                            ...
                            me.contador = 0;
                            me.$emit('codigo_camara', data.codigo); 
