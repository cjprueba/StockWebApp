                    ...
                    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-header">
                          ...
                          <div class="my-1" v-if="tipo !== 2 && tipo !== 3 && tipo !== 4 && tipo!==5">
                          ...
                          <div class="float-right" v-if="deshabilitar.credito && tipo !== 3 && tipo !== 4 && tipo!==5">
                                    ...
                                    <div class="col-md-12">
                                      ...
                                      <!-- GUARANIES -->
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-md-1">
                                            <label for="validationTooltip01">Gs</label>
                                          </div>  
                                    ...
                                    <div class="col-md-12">
                                      ...
                                      <!-- DOLARES -->
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-md-1">
                                            <label for="validationTooltip01">Us</label>
                                          </div> 
                                    ...
                                    <div class="col-md-12">
                                      ...
                                      <!-- PESOS -->
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-md-1">
                                            <label for="validationTooltip01">Ps</label>
                                          </div> 
                                    ...
                                    <div class="col-md-12">
                                      ...
                                      <!-- REALES -->
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-md-1">
                                            <label for="validationTooltip01">Rs</label>
                                          </div> 
	...
	export default {
      ...
      watch: { 
        ...
        fk_venta: function(newVal, oldVal) {
          this.fk_venta_unico=newVal;
         
          this.obtenerCotizacionyMonedaDeVenta();
      ...
      methods: {
          ...
          procesarFormas(){
           ...
           /* this.obtenerCotizacionyMoneda();*/
          ...
          }, obtenerCotizacionyMonedaDeVenta(){
            ...
            Common.cotizacionyMonedaDeVentaFormaPagoCommon(this.fk_venta_unico).then(data => {
                me.cotizacion = data;
            ...
            if (total > medios && this.checked.PAGO_AL_ENTREGAR === false && this.tipo !== 3 && this.tipo !== 5 ) {
        ...
        mounted() {
         ...
         /* me.obtenerCotizacionyMonedaDeVenta();*/
