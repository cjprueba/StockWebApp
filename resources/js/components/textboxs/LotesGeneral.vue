	...
	<div>
			...
			<div class="input-group" id="validationTooltip01" >
				<div class="input-group-prepend">
					<button  type="button" class="btn btn-secondary btn-sm" data-toggle="modal" data-target=".lote-general-modal"><font-awesome-icon icon="search"/></button>
				</div>
	        ...
	        <!-- MODAL LOTES PRODUCTO -->
	                ...
	                <div class="modal fade lote-general-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
	                  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
	                    <div class="modal-content">
	                      ...
	                      <div class="modal-body">
	                            <table id="tablaModalLotesGeneral" class="table table-hover table-bordered table-sm mb-3" style="width:100%">
	                                <thead>
	                                    <tr>
	                                        <th>Codigo</th>
	                                        <th>Descripción</th>
...
<script>
	export default {
      ...
      methods: {
			...
			obtenerDatosLote(codigo, moneda){
	                ...
	                this.tableModalLotes = $('#tablaModalLotesGeneral').DataTable({
	                        "processing": true,
	                        "serverSide": true,
	                        "destroy": true,
	                        "bAutoWidth": true,
	                ...
	                $('#tablaModalLotesGeneral').on('click', 'tbody tr', function() {
