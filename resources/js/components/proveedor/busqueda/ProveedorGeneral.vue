		...
		<div class="card shadow border-bottom-primary" >
			...
			<div class="card-body">
			  	<div class="form-row">
					...
					<div class="col-md-4">
						<label for="validationTooltip01">Seleccione Proveedores</label> 
						<select multiple class="form-control" size="4" v-model="selectedMarca" :disabled="onMarca" v-bind:class="{ 'is-invalid': validarMarca }">
						   <option v-for="marca in marcas" :value="marca.CODIGO">{{ marca.NOMBRE }}</option>
						</select>
						<div class="invalid-feedback">
					        {{messageInvalidMarca}}
					    </div>
        ...
        methods: {
            llamarBusquedas(){	
	          axios.get('busquedas/').then((response) => {
	           	...
	           	this.marcas = response.data.proveedores;
