<template>
  <div class="container-fluid pt-3 bg-light">
              ...
              <div class="row">
                <b-button v-b-toggle.sidebar-1>Filtro</b-button>
                <b-sidebar id="sidebar-1" title="Filtro" shadow>
                  ...
                  <label class="mt-2">BUSQUEDA</label>
                  ...
                  <a href="#" class="btn btn-sm btn-block btn-primary btn-sm mb-3 mt-3" v-on:click="mostrarProductos()">Buscar</a>
                ...
                <div class="col-md-12 order-md-2">
                  <div class="container-fluid">
                    ...
                    <div :class="'row ' + cargar.class" v-if="resultado">
                      <div class="col-6 col-md-6 col-lg-4 mb-3"  v-for="producto in productos">
                        ...
                        <div class="card h-100 border-0 product py-4">
                          ...
                          <div class="card-body text-center">
                            <h6 class="card-title">
                              <span href="product.html" class=" font-weight-bold text-dark text-uppercase small"> {{producto.DESCRIPCION}}</span>
                            </h6>
                            ...
                            <a style="background-color: green;" :href="'https://wa.me/595982864441?text='+producto.CODIGO+'%20-%20NECESITO%20ESTE%20PRODUCTO'" target="_blank" class="btn btn-success btn-sm"><i class="fab fa-whatsapp"></i> Solicitar</a> 
  ...
  export default {
      ...
      methods: {
        inicio(){
          ...
          Common.inicioCatalogoCommon(me.opciones).then(data => {
        ...
        mostrarProductos(){
          ...
          Common.mostrarProductosCatalogoCommon(me.opciones).then(data => {
...
<style scoped>
  .container_checkbox { border:2px solid #ccc; width:280px; height: 200px; overflow-y: scroll; }
