<template>
  		...
  		<div class="clearfix borderbox" id="page"><!-- column -->
		   ...
		   <div class="rounded-corners clearfix colelem" id="u287"><!-- group -->
		    ...
		    <div class="clearfix grpelem" id="u276-4"><!-- content -->
		     <p>{{producto.PREMAYORISTA}}</p>
		    </div>
		   </div>
		   <div class="clearfix colelem" id="u282-4" data-sizePolicy="fluidWidth" data-pintopage="page_fixedCenter"><!-- content -->
		    <p>Descripción</p>
		   </div>
		   <div class="clearfix colelem" id="u279-13"><!-- content -->
		    <p> {{producto.DESCRIPCION_LARGA}} </p>
		    <!-- <p id="u279-2">- ¡El maquillaje se elimina de una vez con leche espumosa!</p>
		    <p id="u279-4">- Puede quitar el maquillaje y lavar la cara de una vez</p>
		    <p id="u279-6">- No requiere lavado doble de la cara. Después del lavado es refrescante.</p>
		    <p id="u279-8">- También se puede usar como un limpiador facial para la cara desnuda</p>
		    <p id="u279-10">- Aroma floral fresco.</p> -->
		    <p>&nbsp;</p>
		   </div>
	...
	export default {
      ...
      methods: {
      	...
      	obtener(){
	        ...
	        Common.obtenerProductoQRCommon({sucursal: me.sucursal, codigo: me.codigo}).then(data => {
	        		me.producto = data.data[0];
...
.version.index{color:#0000EF;background-color:#59C0AF;}#page{z-index:1;min-height:689.5789473684213px;background-image:none;border-width:0px;border-color:#000000;background-color:transparent;padding-bottom:0px;width:100%;}#u162{z-index:4;min-height:62px;background-color:#98E000;padding-bottom:11px;}#u245{z-index:5;background-color:transparent;position:relative;margin-right:-10000px;margin-top:15px;width:88.75%;margin-left:5.63%;left:-1px;}.js body{visibility:hidden;}.js body.initialized{visibility:visible;}#u162-bw{z-index:4;min-height:62px;}#u264-4{z-index:9;background-color:transparent;color:#2F2F2F;font-size:18px;line-height:22px;font-weight:bold;margin-top:24px;position:relative;width:89%;margin-left:5%;}#u255{z-index:7;background-color:transparent;margin-top:32px;position:relative;width:60.25%;margin-left:19.88%;left:-1px;}#u245_img,#u255_img{width:100%;}#u290{z-index:2;background-color:#F0F0F0;border-radius:5px;padding-bottom:7px;margin-top:32px;position:relative;width:88.75%;margin-left:5.63%;left:0px;}#u267-4{z-index:13;background-color:transparent;font-size:20px;color:#404040;line-height:24px;position:relative;margin-right:-10000px;margin-top:8px;width:31.84%;left:3.1%;}#u270-4{z-index:17;background-color:transparent;color:#000000;font-size:20px;line-height:24px;font-weight:bold;position:relative;margin-right:-10000px;margin-top:8px;width:45.36%;left:40.57%;}#u287{z-index:3;background-color:#F0F0F0;border-radius:5px;padding-bottom:7px;margin-top:6px;position:relative;width:88.75%;margin-left:5.63%;left:0px;}#u273-4{z-index:21;background-color:transparent;font-size:20px;color:#404040;line-height:24px;position:relative;margin-right:-10000px;margin-top:8px;width:31.84%;left:3.1%;}#u276-4{z-index:25;background-color:transparent;color:#000000;font-size:20px;line-height:24px;font-weight:bold;position:relative;margin-right:-10000px;margin-top:8px;width:45.36%;left:40.57%;}#u282-4{z-index:42;background-color:transparent;color:#4B7429;font-size:20px;text-align:center;line-height:24px;font-weight:bold;margin-top:25px;position:relative;width:36%;margin-left:32%;left:0px;}#u279-13{z-index:29;min-height:134px;background-color:transparent;margin-top:10px;position:relative;width:88.75%;margin-left:5%;}#u279-2,#u279-4,#u279-6,#u279-8,#u279-10{font-size:12px;line-height:18px;}.css_verticalspacer .verticalspacer{height:calc(100vh - 732px);}#muse_css_mq,.html{background-color:#FFFFFF;}body{position:relative;min-width:320px;}	
