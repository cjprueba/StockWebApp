...
<html>
	...
	<body>
		@if ($VALOR_NUTRCIONAL_CHECK == true && $PROPIEDADES_CHECK == true && $FORMA_DE_USO_CHECK == true)
		<p class="col-2">
	    ...
	    @endif
	    @if ($VALOR_NUTRCIONAL_CHECK == false && $PROPIEDADES_CHECK == true && $FORMA_DE_USO_CHECK == true)
		<p class="col-2">
            <p align="center"><font size="9">{{$MARCA}}</font></p>
            <p class="normal">{{$NOMBRE_DEL_PRODUCTO}}</p>
            <p class="normal">{{$PROPIEDADES}}</p>
	    ...
	    @endif
	    @if ($VALOR_NUTRCIONAL_CHECK == false && $PROPIEDADES_CHECK == false && $FORMA_DE_USO_CHECK == true)
		<p class="col-2">
	    ...
	    @endif
	    @if ($VALOR_NUTRCIONAL_CHECK == false && $PROPIEDADES_CHECK == false && $FORMA_DE_USO_CHECK == false)
		<p class="col-2">
            <p align="center"><font size="9">{{$MARCA}}</p>
            <p class="normal">{{$NOMBRE_DEL_PRODUCTO}}</p>
            <p class="normal">INGREDIENTES: {{$INGREDIENTES}}</p>
