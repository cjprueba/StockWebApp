...
class Compra extends Model
{
	...
	public static function ultimo_codigo() {
		...
		$codigo = Compra::select(DB::raw('IFNULL(CODIGO,0) AS CODIGO'))
		->where(['ID_SUCURSAL' => $user->id_sucursal])
		->orderBy('CODIGO', 'desc')
		->first();
...
public static function generar_Reporte_Entrada_Seccion($datos) 
    ...
    public static function generar_Reporte_Entrada_Contenedor_Seccion($datos) 
    {
         ...
         // INCICIAR VARIABLES 
            ...
            $totalcosto=0;
                 ...
                 if($insert==true){
                     ...
                     Temp_venta::insertar_reporte_Entrada_Contenedor_Seccion($data);
                    }
