...
class Producto extends Model
{
    ...
    public static function encontrarProductoDesc($data)
    {
        ...
        $producto = ProductosAux::rightjoin('DESCRIPCION_DETALLADA', 'DESCRIPCION_DETALLADA.CODIGO', '=', 'PRODUCTOS_AUX.CODIGO')
        ...
        ->select(DB::raw('
            ...
            IFNULL(length(DESCRIPCION_DETALLADA.MARCA),0) AS CHECK_MARCA,
    ...
    public static function encontrarProductoDescOld($data)
    {
        ...
        $producto = ProductosAux::rightjoin('DETALLE_PROD', 'DETALLE_PROD.COD_PROD', '=', 'PRODUCTOS_AUX.CODIGO')
        ->leftjoin('PRODUCTOS', 'PRODUCTOS.CODIGO', '=', 'PRODUCTOS_AUX.CODIGO')
        ->select(DB::raw('
            PRODUCTOS_AUX.CODIGO, 
            PRODUCTOS_AUX.CODIGO_INTERNO,
    ...
    public static function obtener_datos($datos){
        ...
        ->select(DB::raw('PRODUCTOS_AUX.CODIGO,
                          ...
                          PRODUCTOS.DESCRIPCION, 
                          PRODUCTOS_AUX.DESCUENTO AS DESCUENTO,
                          PRODUCTOS.IMPUESTO AS IVA, 
                          PRODUCTOS.LINEA,
                          PRODUCTOS.SUBLINEA,
                          IFNULL(PRODUCTOS.SUBLINEADET,0) AS SUBLINEADET,
            ...
            foreach ($posts as $post)
            {
                ...
                // BUSCAR IMAGEN
                    ...
                    if(file_exists($filename)) {
                        $imagen_producto = ''.env("URL_FILE").'/storage/imagenes/productos/'.$post->CODIGO.'.jpg';
