        ...
        if(!empty($posts))
        {
            foreach ($posts as $post)
            {
                ...
                if($user->can("inventario.mostrar.procesar")){
                    ...
                    &emsp;<a href='#' id='imprimirInventario' title='Imprimir'><i class='fa fa-print text-primary' aria-hidden='true'></i></a>&emsp;<a href='#' id='procesarInventario' title='Procesar'><i class='fa fa-check-square text-success' aria-hidden='true'></i></a>
                    ";
