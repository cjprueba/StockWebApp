...
class VentaGondolaSeccion implements FromArray, WithTitle,WithEvents,ShouldAutoSize,WithColumnFormatting 
{
private $CODIGO;
    ...
    */
            public function __construct($hoja,$seccion,$descri_s)
    {
    	$this->hojas=$hoja;
    ...
    public function  array(): array
    {
    	...
    	$dia2='2020-11-30';
    	 ...
    	 /* $temp=DB::connection('retail')->table('temp_ventas')
	           ...
	           ->select(
	            DB::raw('temp_ventas.LINEA_CODIGO AS CATEGORIA'),
			          ...
			          ->toArray();
                       foreach ($TOTAL as $key => $value) {
			            ...
			            $marcas_array[]=array(
			                ...
			                'TOTAL'=> $value->TOTAL,  
			                'PORCENTAJE'=>(100*$value->TOTAL)/$total_porcentaje,
			             );
                       	# code...
                       }
...
/*	          if(count($ser)>0){
                 ...
                 $this->cantidadvendida=$this->cantidadvendida+$ser[0]->VENDIDO;
	               ...
	               $marcas_array[]=array(
                	...
                	'PORCENTAJE'=>(100*$ser[0]->PRECIO_SERVICIO)/$total_porcentaje,
                	);
	          }*/
	             $marcas_array[]=array(
                'TOTALES'=> 'GENERAL',
