...
class VentaMensualMarcaCategoria  implements FromArray, WithTitle,WithEvents,ShouldAutoSize,WithColumnFormatting 
{
	private $CODIGO;
    ...
    */
            public function __construct($hoja,$Marca_codigo,$descriM,$Linea_Codigo,$descriL)
    {
    	$this->hojas=$hoja;
     
        $this->Marca=$Marca_codigo;
        $this->Linea=$Linea_Codigo;
        $this->descri_M=$descriM;
         $this->descri_L=$descriL;
    }
          ...
          $marcas_array[]=array('COD_PROD','LOTE','STOCK','MARCA','CATEGORIA','SUBCATEGORIA','VENDIDO','PRECIO_UNIT','TOTAL','DESCUENTO','COSTO_UNIT','COSTO_TOTAL','DESCUENTO_PORCENTAJE');
			           ...
			           ->select(
			            ...
			            ->where('temp_ventas.proveedor','<>',19)
			             ->where('temp_ventas.MARCAS_CODIGO','=',$this->Marca)
