...
class RptVentaMarca implements FromArray, WithTitle,WithEvents,ShouldAutoSize,WithColumnFormatting 
{
    private $CODIGO;
    ...
    */
            public function __construct($datos)
    {
         ...
         $this->Marca=$datos["MARCA_CODIGO"];
         $this->Linea=$datos["LINEA_CODIGO"];
         $this->descri_M=$datos["DESCRI_M"];
    ...
    public function title(): string
    {
         if($this->hojas==1){
         	...
         	$titulo=$this->descri_M." ".$this->descri_L;
