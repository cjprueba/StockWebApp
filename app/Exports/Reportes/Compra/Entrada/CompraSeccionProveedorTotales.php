...
class CompraSeccionProveedorTotales implements FromArray, WithTitle,WithEvents,ShouldAutoSize,WithColumnFormatting
{
    ...
    */
    public function __construct($secciones_proveedores)
    {
    	
    	$this->seccion_proveedor=$secciones_proveedores;
