...
use App\Exports\VentaTransferenciaConsignacion;
use App\Exports\VentaTransferenciaConsignacionTotales;
USE Illuminate\Support\Facades\Schema;
use Illuminate\Database\Schema\Blueprint;
use Illuminate\Support\Facades\Log;
use DateTime;

class VentaTransferenciaConsignacionExport implements WithMultipleSheets
{
     private $marca;
	   ...
	   $reporte=DB::connection('retail')->table('VENTASDET')
           ...
           ->leftjoin('VENTAS',function($join){
            ...
            DB::raw('VENTASDET.COD_PROD AS COD_PROD,
             ...
             VENTAS.ID AS ID,
             TRANSFERENCIAS.CONSIGNACION AS CONSIGNACION,
       ...
       //->Where('VENTASdet.FECALTAS','like',$dia.'%')
        ...
        ->orderby('VENTASDET.COD_PROD')
         ...
         foreach ($reporte as $key => $value) {
          ...
          $this->sheets[]= new VentaTransferenciaConsignacion(1,"reporte",'-','-');
          $this->hojas=$this->hojas+1;
}
         $this->sheets[]= new VentaTransferenciaConsignacionTotales();
          ...
          $temp=DB::connection('retail')->table('temp_ventas')
	          ...
	          foreach ($temp as $key => $value) {
	          	...
	          	$this->sheets[]= new VentaTransferenciaConsignacion(2,"reporte",$value->PROVEEDOR,$value->DESCRI_P);
	          	# code...
	          }
