...
class ExportStock implements FromArray, WithTitle,WithEvents,ShouldAutoSize
{
	 private $CODIGO;
  ...
  private  $igualtot;
    ...
    */
     ...
     public function  array(): array
    {
      ...
      $marcas_array[]=array('MARCAS',"",'STOCK MAYOR');
