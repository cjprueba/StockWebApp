...
class DescuentoMarca implements WithMultipleSheets
{
  private $marca;
            ...
            public function sheets(): array
    {
      ...
      if ($this->hojas==1){
        ...
        $this->ventageneral = DB::connection('retail')->table('VENTASDET')->SELECT(DB::raw('VENTASDET.COD_PROD AS COD_PROD'),
         ...
         $this->sheets[]=new DescuentoMarcaPorMes(1,"a<",1,"as",$this->hojas,$this->ventageneral);
        $this->hojas=$this->hojas+1;
         ...
         ->WHERE('VENTASDET.ID_SUCURSAL','=',$this->sucursal)
         ->where('VENTASDET.DESCRIPCION', 'like', 'DESCUENTO%')
        ...
        ->GROUPBY ('PRODUCTOS.LINEA')
         ...
         foreach ($RESULTS as $KEY  => $value) {
          ...
          $this->sheets[]= new DescuentoMarcaPorMes($value->Marca,$descrim,$value->Linea,$descrili,$this->hojas,$this->ventageneral);
